...
func (m *JWTManager) Parse(tokenString string) (model.AuthUser, error) {
	...
	token, err := jwt.ParseWithClaims(tokenString, claims,
		func(t *jwt.Token) (any, error) {
			// WAJIB: pastikan algoritmanya benar HMAC, mencegah alg "none"/tukar algoritma.
	...
	return model.AuthUser{UserID: userID, Username: claims.Username, Role: string(claims.Role)}, nil
}
